...
def limpiarPeliculas(pelis):
     print("\n\t\t\t...::: BORRAR CARACTERISTICA TODAS LAS PELICULAS :::... \n")
     opc=""
     while opc!="si" and opc!="no":
         opc=input("¿Estas seguro que deseas borrar TODAS las peliculas (Si/No)? ").lower().strip()
     if opc=="si":
...
def borrarPeliculas(pelis):
     print("\n\t\t\t...::: MOFICICAR CARACTERISTICA APELICULAS :::... \n")
     ...
     for i in pelis:
           if peli==i:
             ...
             while opc!="si" and opc!="no":
               ...
               noencontro=True
             if opc=="si":
                pelis(peli)=input("¿Escribe el nuevo valor de la caracteristica de la pelicula (Si/No)?").upper().strip()
                funciones.accionExitosa
             if noencontro:
